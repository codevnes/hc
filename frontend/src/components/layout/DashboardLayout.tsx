...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  const navItems = (
    <>
      ...
      <NavLink href="/dashboard/posts/create" icon={<FaPlus />} currentPath={pathname}>Tạo bài viết</NavLink>
  ...
  return (
    <div className="flex min-h-screen bg-background">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block w-64 border-r border-border flex-col">
      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
           {/* Desktop Header (Optional) - Could show current page title */}
           <div className="hidden lg:flex items-center">
              <h1 className="font-semibold text-lg md:text-2xl">Trang chủ Dashboard</h1> {/* Example Title */}
           </div>
          {children}
        </main>
      </div>
